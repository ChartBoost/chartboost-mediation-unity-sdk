...
const void * _chartboostMediationFullscreenAdQueueQueue(const char * placementName)
{
...
const void * _chartboostMediationFullscreenAdQueueGetNextAd(const void * uniqueId)
{
    ChartboostMediationFullscreenAdQueue * queue = (__bridge ChartboostMediationFullscreenAdQueue *)uniqueId;
