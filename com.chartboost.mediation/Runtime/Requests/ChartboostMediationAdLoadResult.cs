namespace Chartboost.Requests
{
    ...
    /// </summary>
    public class ChartboostMediationAdLoadResult 
    {
        /// <summary>
        ...
        public ChartboostMediationAdLoadResult(string loadId, Metrics? metrics, ChartboostMediationError? error)
        {
            LoadId = loadId;
            Metrics = metrics;
            Error = error;
        ...
        /// </summary>
        public ChartboostMediationAdLoadResult(ChartboostMediationError error)
        {
            LoadId = string.Empty;
            Metrics = null;
            Error = error;
