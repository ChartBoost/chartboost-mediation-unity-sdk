...
namespace Helium
{
    public class JsonParseTests
    {
        ...
        string[] testFiles = new string[]
        {
            ...
            "x_n_array_comma_and_number.json",
            "x_n_array_double_comma.json",
            "x_n_array_double_extra_comma.json",
            "n_array_extra_close.json",
            "x_n_array_extra_comma.json",
            ...
            "x_n_array_just_comma.json",
            "n_array_just_minus.json",
            "x_n_array_missing_value.json",
            "n_array_newlines_unclosed.json",
            "x_n_array_number_and_comma.json",
            "x_n_array_number_and_several_commas.json",
            ...
            "x_n_multidigit_number_then_00.json",
            "n_number_++.json",
            "n_number_+1.json",
            "n_number_+Inf.json",
            "x_n_number_-01.json",
            ...
            "n_number_-NaN.json",
            "n_number_.-1.json",
            "x_n_number_.2e-3.json",
            "n_number_0.1.2.json",
            "n_number_0.3e+.json",
            "n_number_0.3e.json",
            "x_n_number_0.e1.json",
            ...
            "n_number_1_000.json",
            "n_number_1eE2.json",
            "x_n_number_2.e+3.json",
            "x_n_number_2.e-3.json",
            "x_n_number_2.e3.json",
            "n_number_9.e+.json",
            "n_number_Inf.json",
            "x_n_number_NaN.json",
            "n_number_U+FF11_fullwidth_digit_one.json",
            "n_number_expression.json",
            "x_n_number_hex_1_digit.json",
            "x_n_number_hex_2_digits.json",
            "x_n_number_infinity.json",
            ...
            "x_n_number_minus_infinity.json",
            "n_number_minus_sign_with_trailing_garbage.json",
            "n_number_minus_space_1.json",
            "x_n_number_neg_int_starting_with_zero.json",
            "x_n_number_neg_real_without_int_part.json",
            "n_number_neg_with_garbage_at_end.json",
            "n_number_real_garbage_after_e.json",
            "n_number_real_with_invalid_utf8_after_e.json",
            "x_n_number_real_without_fractional_part.json",
            "x_n_number_starting_with_dot.json",
            "n_number_with_alpha.json",
            "n_number_with_alpha_char.json",
            "x_n_number_with_leading_zero.json",
            ...
            "x_n_object_key_with_single_quotes.json",
            "x_n_object_lone_continuation_byte_in_key_and_trailing_comma.json",
            "n_object_missing_colon.json",
            "n_object_missing_key.json",
            "n_object_missing_semicolon.json",
            "n_object_missing_value.json",
            "n_object_no-colon.json",
            "x_n_object_non_string_key.json",
            "x_n_object_non_string_key_but_huge_number_instead.json",
            "x_n_object_repeated_null_null.json",
            "n_object_several_trailing_commas.json",
            "x_n_object_single_quote.json",
            "x_n_object_trailing_comma.json",
            "x_n_object_trailing_comment.json",
            "n_object_trailing_comment_open.json",
            "n_object_trailing_comment_slash_open.json",
            "n_object_trailing_comment_slash_open_incomplete.json",
            "n_object_two_commas_in_a_row.json",
            "x_n_object_unquoted_key.json",
            ...
            "x_n_string_single_quote.json",
            "n_string_single_string_no_double_quotes.json",
            "n_string_start_escape_unclosed.json",
            "x_n_string_unescaped_ctrl_char.json",
            "x_n_string_unescaped_newline.json",
            "x_n_string_unescaped_tab.json",
            ...
            "x_n_structure_null-byte-outside-string.json",
            "n_structure_number_with_trailing_garbage.json",
            "n_structure_object_followed_by_closing_object.json",
            "n_structure_object_unclosed_no_value.json",
            "x_n_structure_object_with_comment.json",
            ...
            "x_n_structure_whitespace_formfeed.json",

            // Acceptance as Accept
        ...
        {
            Debug.Log(string.Format("Running ExhaustiveJSONTest over a total of {0} files", testFiles.Length));
            int skippedCount = 0;
            int expectedFails = 0;

            foreach (string testFile in testFiles)
            {
                Expectation expectation = GetExpectation(testFile);
                ...
                Acceptance acceptance = GetAcceptance(testFile);

                // Read in the JSON
                string path = string.Format("Packages/com.chartboost.helium/Tests/TestJSON/{0}", testFile);
