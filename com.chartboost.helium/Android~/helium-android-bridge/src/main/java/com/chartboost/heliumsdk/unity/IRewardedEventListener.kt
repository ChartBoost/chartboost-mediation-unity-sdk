...
interface IRewardedEventListener {
    fun DidLoadRewarded(placementName: String, loadId: String, error: String)
    ...
    fun DidWinBidRewarded(placementName: String, auctionId: String, partnerId: String, price: Double, error: String)
}
